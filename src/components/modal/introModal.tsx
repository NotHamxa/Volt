        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    className="relative flex flex-col items-center justify-center w-96 px-10 py-12 gap-6 rounded-2xl bg-surface-modal/[0.98] border border-line-070 shadow-[0_40px_90px_var(--shadow-3),inset_0_1px_0_var(--edge-hi)]"
                >
                    <motion.div
